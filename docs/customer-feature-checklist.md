# RideSync Customer Feature Checklist

## Beta Readiness

- [x] HTTPS deployment on Render
- [x] Invite link deep-link routing
- [x] Organizer invite rotation and invalidation
- [x] Organizer close-ride lifecycle
- [x] Privacy, Terms, and Delete Data pages
...
- [ ] Regroup alert broadcast action
- [ ] ETA to selected waypoint for each rider
- [ ] Geofence arrival notifications for waypoints
- [ ] Co-host role with organizer-level controls
- [ ] Ride summary export after close
